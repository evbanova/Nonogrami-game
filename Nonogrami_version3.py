...
button_solved_puzzles = tk.Button(frame0, text='Solved puzzles', width=15, height=2,  bg='pale violet red')
...
button_solved_puzzles.grid(row=3, column=1, padx=180, pady=5)
